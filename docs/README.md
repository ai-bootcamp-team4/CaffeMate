...
2. [시스템 아키텍처](./architecture/system-architecture.md)
3. [상태와 워크플로](./architecture/state-and-workflows.md)
4. [의사결정 모델](./architecture/decision-model.md)
5. [데이터와 그라운딩](./architecture/data-and-grounding.md)
6. [에이전트와 MCP](./architecture/agent-and-mcp.md)
7. [가드레일](./architecture/guardrails.md)
8. [평가 계획](./evaluation/evaluation-plan.md)
9. [구현 계획](./implementation-plan.md)
10. [프론트엔드 배포](./deployment.md)
