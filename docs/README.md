...
| 영역 | 상태 | 설명 |
| --- | --- | --- |
| React 결과 화면 | 구현됨 | Control API 결과와 근거 설명·조건 변경 UI |
...
| API·MCP·Agent·RAG | 계약 작성 중·Agent 차단 | Vertex AI RAG Engine은 주 검색 계층으로 확정됐으나 resource는 아직 없고, 서울 생성 model id 승인이 필요 |
