...
- 현재 저장소에는 React 결과 목업·frontend 배포 scaffold, FastAPI State core와 로컬 Agent·MCP·RAG·parsing/indexing 코어가 있다.
- production 데이터베이스와 GCP Agent Runtime·MCP Cloud Run·RAG Engine resource는 아직 없다.
